...
Atmosphere.Moon = function (context, x, y, ratio, tint) {
    ...
    return new function () {
        this.settings = { context: context, xPos: x || 0, yPos: y || 0, sizeRatio: ratio, tint: tint || '#fff'};
      ...
      ctx.bezierCurveTo(moonSize * 0.00222, moonSize * 0.90055, moonSize * 0.01555, moonSize * 0.85166, moonSize * 0.01666, moonSize * 0.85888);
